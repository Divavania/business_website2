...
use App\Http\Controllers\Backend\CompanyInfoController; // Tambahkan ini
...
Route::delete('/contacts/{id}', [BackendContactController::class, 'destroy'])->name('contacts.destroy'); // Tambahkan ini
