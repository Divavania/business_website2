...
@section('description', 'Selamat datang di Tigatra Adikara, perusahaan terkemuka dalam...') {{-- Tambahkan deskripsi --}}
@section('keywords', 'Tigatra Adikara, home, services, portfolio, about us') {{-- Tambahkan keywords --}}
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item active">
          <img src="{{ asset('template-assets/img/hero-carousel/hero-carousel-1.jpg') }}" alt="">
          <div class="carousel-container">
            <h2>Welcome to Tigatra Adikara<br></h2> {{-- Ubah teks --}}
        ...
        <div class="carousel-item">
          <img src="{{ asset('template-assets/img/hero-carousel/hero-carousel-2.jpg') }}" alt="">
          <div class="carousel-container">
        ...
        <div class="carousel-item">
          <img src="{{ asset('template-assets/img/hero-carousel/hero-carousel-3.jpg') }}" alt="">
          <div class="carousel-container">
