...
@section('title', 'Home | Tigatra Adikara') {{-- Menambahkan title spesifik halaman --}}
@section('description', 'Selamat datang di Tigatra Adikara, perusahaan terkemuka dalam berbagai layanan profesional dan solusi inovatif.') {{-- Menambahkan deskripsi spesifik halaman --}}
@section('keywords', 'Tigatra Adikara, home, services, portfolio, about us, solusi bisnis') {{-- Menambahkan keywords spesifik halaman --}}
    ...
    <section id="about-2" class="about-2 section">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row g-4 g-lg-5" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-5">
            <div class="about-img">
              <img src="{{ asset('template-assets/img/about-portrait.jpg') }}" class="img-fluid" alt=""> {{-- Ubah path gambar --}}
            </div>
          </div>
